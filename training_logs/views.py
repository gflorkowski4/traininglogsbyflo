...
def new_topic(request):
    ...
    if request.method != 'POST':
        ...
        if form.is_valid():
            ...
            new_topic.save()
            return redirect('training_logs:topics')
...
def new_entry(request, topic_id):
    ...
    if request.method != 'POST':
        ...
        if form.is_valid():
            ...
            new_entry.save()
            return redirect('training_logs:topic',topic_id=topic_id)
...
def edit_entry(request, entry_id):
    ...
    if request.method != 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('training_logs:topic', topic_id = topic.id)
    context = {'entry': entry, 'topic':topic,'form':form}
    return render(request, 'training_logs/edit_entry.html',context)
